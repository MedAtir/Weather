  ...
  return (
    <>
      ...
      <Row className="border bg-light p-2">
        <Col className="fs-2 fw-bolder bg-info  text-light"style={{display:"flex", justifyContent:"center", alignItems:"center"}}>{today.temp}°C</Col>
        <Col className=" bg-primary text-light" style={{display:"flex", justifyContent:"center", alignItems:"center"}}>
          {today.main}, {today.desc}
        </Col>
        <Col className="fs-4 fw-bolder" style={{display:"flex", justifyContent:"center", alignItems:"center"}}>
          {" "}
